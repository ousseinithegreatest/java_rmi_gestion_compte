...
import sn.supdeco.gescompte.exception.CompteDebitException;
...
public class GestCompteClient {
    public static void main(String[] args) throws RemoteException {
        ...
        try {
            ...
            System.out.println("Vous devez remplir les informations demandees pour creer un utilisateur");
            ...
            System.out.println("1. Crediter le compte");
            System.out.println("2. Debiter le compte");
